...
public sealed class BreakThroughOnAllFronts() : TashkentCard(2, CardType.Power, CardRarity.Rare, TargetType.Self)
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        new PowerVar<BreakThroughOnAllFrontsPower>(1M)
    ];
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<BreakThroughOnAllFrontsPower>(choiceContext, base.Owner.Creature, base.DynamicVars["BreakThroughOnAllFrontsPower"].BaseValue, base.Owner.Creature, this);
    }
