...
public sealed class MotivationBurstPower : IndomitablePower
{
    ...
    public override int DisplayAmount => OverflowThreshold - GetInternalData<MotiBurstData>().OverflowAccumulated % OverflowThreshold;
    public override bool IsInstanced => true; // 允许有内部独立数据
    
    protected override object InitInternalData() => new MotiBurstData();
    ...
    {
        var data = GetInternalData<MotiBurstData>();
