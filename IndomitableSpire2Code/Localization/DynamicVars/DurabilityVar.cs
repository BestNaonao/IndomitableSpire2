...
/// </summary>
public class DurabilityVar(string name, decimal baseValue) : DynamicVar(name, baseValue)
{
    // 记录预览时将要损失的耐久度
    ...
    public override string ToString()
    {
        ...
        if (_predictedLoss > 0 && BaseValue > 0)
            return $"({IntValue}-[red]{_predictedLoss}[/red])";
