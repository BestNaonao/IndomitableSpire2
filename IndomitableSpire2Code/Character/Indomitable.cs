...
public abstract class Indomitable : CustomCharacterModel
{
    ...
    protected SkinDefinition CurrentSkinDefinition => SkinManager.GetDefinition(CurrentSkin);
    
    // 角色名称等的颜色，STS2 使用 Godot 的 Color 结构体
    ...
    // 每个皮肤的特色资源
    public override Color MapDrawingColor => CurrentSkinDefinition.MapDrawingColor;
    public override string CustomVisualPath => CurrentSkinDefinition.VisualPath;
    public override string CustomRestSiteAnimPath => CurrentSkinDefinition.RestSiteAnimPath;
    public override string CustomMerchantAnimPath => CurrentSkinDefinition.MerchantAnimPath;
    public override string CustomIconTexturePath => CurrentSkinDefinition.IconTexturePath;
    public override string CustomIconPath => CurrentSkinDefinition.IconPath;
    public override string CustomIconOutlineTexturePath => CurrentSkinDefinition.IconOutlineTexturePath;
    public override string CustomArmPaperTexturePath => CurrentSkinDefinition.ArmPaperTexturePath;
    public override string CustomArmPointingTexturePath => CurrentSkinDefinition.ArmPointingTexturePathFunc();
